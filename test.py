...
from src.speech_text_paired_dataset import (load_speech_text_paired_dataset, 
        get_waveform)
...
model_path = '/home/zth/work/new/Whisper_Finetune/checkpoints/librispeech_v2'
...
def main():
    ...
    model = WhisperForConditionalGeneration.from_pretrained('checkpoints/librispeech_v2')
    model.eval()
    model.to(device)
